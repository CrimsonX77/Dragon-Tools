    ...
    def initialize(self):
        ...
        try:
            ...
            if not os.getenv('GOOGLE_APPLICATION_CREDENTIALS'):
                raise RuntimeError("GOOGLE_APPLICATION_CREDENTIALS environment variable not set. See: https://cloud.google.com/docs/authentication/getting-started")
...
class DictationGUI(QMainWindow):
    ...
    def check_backend_availability(self):
        ...
        if has_deps and has_creds:
            status_lines.append("✅ Google Cloud: Available")
        elif not has_deps:
            status_lines.append("❌ Google Cloud: Missing google-cloud-speech package")
        elif not has_creds:
            status_lines.append("⚠️ Google Cloud: Missing GOOGLE_APPLICATION_CREDENTIALS env var")
